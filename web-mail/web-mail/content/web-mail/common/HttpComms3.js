function HttpComms(oLog)
{
    try
    {
        ...
        this.m_szUserAgent = "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:24.0) Gecko/20100101 Firefox/24.0";
...
HttpComms.prototype =
{
    ...
    send : function (callback, parent)
    {
        try
        {
            ...
            {
                var aszCookie = this.m_oCookies.findCookie(this.m_szUserName, this.m_szURI);
        ...
        try
        {
            ...
            if (mainObject.m_bHandleCookie)
            {
                ...
                try
                {
                    ...
                    mainObject.m_oCookies.addCookie(mainObject.m_szUserName, httpChannel.URI.spec, szCookies);
                }
                catch(e)
                {
