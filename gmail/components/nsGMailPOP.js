    ...
    loginOnloadHandler : function(szResponse ,event , mainObject)
    {
        try
        {
            		...
            		szResponse.search(PatternGmailWelcome)!=-1)
            {
      		...
      		if (mainObject.m_iStage ==0 && szResponse.search(/logout/i) != -1)
      		{
      			mainObject.m_iStage =1;  //already login
      			mainObject.m_Log.Write("nsGMailPOP.js - loginOnloadHandler - already login");
      		}
