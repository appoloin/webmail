...
YahooPOPBETA.prototype =
{
        ...
        try
        {
            ...
            switch (mainObject.m_iStage)
            {
                ...
                case 2: //mail box
                    ...
                    //process folder list
                    var aszFolders = szResponse.match(kPatternFolderList)[0].match(kPatternFolderData);
    ...
    mailBox : function (bState)
    {
        ...
        var szData = kLstMsgs.replace(/MSGLIST/,szFolderName);

        var szURI = this.m_szLocationURI + "/ws/mail/v2.0/jsonrpc?appid=YahooMailNeo&m=ListFolderThreads&wssid="+this.m_szWssid;
        ...
        try
        {
            ...
            if (aszResponses.length>0)
            {
            	try
            	{
	                ...
	                var aTemp = mainObject.m_aRawData.concat(szFolderInfo);
            ...
            if (mainObject.m_aszFolderList.length>0) //load next folder
            {
                ...
                var szURI = mainObject.m_szLocationURI + "/ws/mail/v2.0/jsonrpc?appid=YahooMailNeo&m=ListFolderThreads&wssid="+mainObject.m_szWssid;
                mainObject.m_Log.Write("YahooPOPBETA.js - mailBox - szURI " + szURI);
                mainObject.m_HttpComms.setURI(szURI);
                mainObject.m_HttpComms.setRequestMethod("POST");
        ...
        try
        {
            ...
            if (this.m_aRawData.length>0)
            {
                ...
                do{
                    ...
                    //folder info
                    this.m_szBox = Item.match(kPatternFolderSource)[1];
